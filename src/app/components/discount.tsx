  ...
  return <div className="mb-10">
    <div className="container m-auto bg-crimson-300">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 h-96">
        <div className="xl:ml-3 h-full w-full bg-contain bg-center bg-no-repeat hidden sm:block" style={{ backgroundImage: 'url(./discount.svg' }}></div>

        <div className="flex justify-center text-center text-white h-full flex-col">
          <div>
          <div className="text-3xl font-bold">O SEU PACOTE DE SAÚDE MENTAL</div>
          ...
          <br />
          <div className="text-3xl font-bold">POR</div>
